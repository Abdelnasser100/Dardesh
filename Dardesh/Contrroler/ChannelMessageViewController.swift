//
//  ChannelMessageViewController.swift
//  Dardesh
//
...
class ChannelMessageViewController: MessagesViewController {
...
//        let titel = UILabel(frame: CGRect(x: 5, y: 22, width: 50, height: 25))
//        titel.textAlignment = .left
...
extension ChannelMessageViewController:GalleryControllerDelegate{
